...
function DesktopSvg({ height = 25, width = 25, className, ...props }) {
  ...
  return (
    ...
    >
      ...
      />
      <circle cx={485.72} cy={79} r={4} fill={objectColor} />
      <circle
        cx={485.72}
        cy={46}
        r={4}
      ...
      />
      <circle cx={485.72} cy={251} r={4} fill={objectColor} />
      <path
        stroke={objectColor}
        strokeMiterlimit={10}
        strokeWidth={2}
      ...
      />
      <circle cx={333.22} cy={168.5} r={4} fill={objectColor} />
      ...
      />
      <circle cx={637.22} cy={168.5} r={4} fill={objectColor} />
      <circle
        cx={686.22}
        cy={168.5}
        r={4}
      ...
      <path fill={pencilColor} d="M835.72 288h16v33h-16z" />
      <path fill="#535461" d="M857.72 329h16v100h-16z" />
      <path fill={pencilColor} d="M857.72 296h16v33h-16z" />
      <path fill="#535461" d="M884.72 346h16v100h-16z" />
      <path fill={pencilColor} d="M884.72 313h16v33h-16z" />
      <path
